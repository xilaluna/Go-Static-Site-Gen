...
- [x] Add any third party library to your project to enhance it's functionality. Some ideas you might consider include **_(CHOOSE ONLY ONE)_**:
  ...
  - [x] **_FILL IN THE BLANK_**: `I will use the https://github.com/gomarkdown/markdown library. The documentation is located at https://github.com/gomarkdown/markdown. My goal is to use it to generate html pages from markdown.`
- [x] **Add, commit, and push to GitHub**.
